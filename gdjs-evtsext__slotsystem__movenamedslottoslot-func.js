...
gdjs.evtsExt__SlotSystem__MoveNamedSlotToSlot.idToCallbackMap = new Map();
...
let isConditionTrue_0 = false;
{
{gdjs.evtTools.network.jsonToVariableStructure(gdjs.evtTools.network.variableStructureToJSON(runtimeScene.getScene().getVariables().get("__SlotSystem").getChild("_NamedSlots").getChild(eventsFunctionContext.getArgument("FromSpaceName")).getChild(eventsFunctionContext.getArgument("FromSlot"))), runtimeScene.getScene().getVariables().get("__SlotSystem").getChild(eventsFunctionContext.getArgument("ToSpaceName")).getChild(eventsFunctionContext.getArgument("ToSlot")));
}
}
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
isConditionTrue_0 = gdjs.evtsExt__SlotSystem__IsNamedSlotFilled.func(runtimeScene, eventsFunctionContext.getArgument("FromSpaceName"), eventsFunctionContext.getArgument("FromSlot"), eventsFunctionContext);
if (isConditionTrue_0) {
isConditionTrue_0 = false;
