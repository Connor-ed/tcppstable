...
if (typeof gdjs.evtsExt__SlotSystem__SetSlotItem !== "undefined") {
  gdjs.evtsExt__SlotSystem__SetSlotItem.registeredGdjsCallbacks.forEach(callback =>
    gdjs._unregisterCallback(callback)
  );
}

gdjs.evtsExt__SlotSystem__SetSlotItem = {};
gdjs.evtsExt__SlotSystem__SetSlotItem.idToCallbackMap = new Map();


gdjs.evtsExt__SlotSystem__SetSlotItem.eventsList0 = function(runtimeScene, eventsFunctionContext) {
...
gdjs.evtsExt__SlotSystem__SetSlotItem.func = function(runtimeScene, SpaceName, Slot, Item, parentEventsFunctionContext) {
...
gdjs.evtsExt__SlotSystem__SetSlotItem.eventsList0(runtimeScene, eventsFunctionContext);


return;
}

gdjs.evtsExt__SlotSystem__SetSlotItem.registeredGdjsCallbacks = [];