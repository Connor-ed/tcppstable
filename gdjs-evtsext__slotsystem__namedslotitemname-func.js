...
gdjs.evtsExt__SlotSystem__NamedSlotItemName.idToCallbackMap = new Map();
...
{eventsFunctionContext.returnValue = gdjs.evtsExt__SlotSystem__NamedSlotTextContent.func(runtimeScene, eventsFunctionContext.getArgument("SpaceName"), eventsFunctionContext.getArgument("SlotName"), "Item", "", eventsFunctionContext);}
}
