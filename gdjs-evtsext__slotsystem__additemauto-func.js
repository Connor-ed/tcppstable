...
gdjs.evtsExt__SlotSystem__AddItemAuto.idToCallbackMap = new Map();
...
isConditionTrue_0 = false;
{
isConditionTrue_1 = gdjs.evtsExt__SlotSystem__IsSlotUnlimited.func(runtimeScene, eventsFunctionContext.getArgument("SpaceName"), gdjs.evtTools.variable.getVariableNumber(runtimeScene.getScene().getVariables().get("__SlotSystem").getChild("_TmpVal")), eventsFunctionContext);
if(isConditionTrue_1) {
    isConditionTrue_0 = true;
}
}
{
{isConditionTrue_1 = ((Number(eventsFunctionContext.getArgument("Maximum")) || 0) == 0);
}
if(isConditionTrue_1) {
    isConditionTrue_0 = true;
}
