...
gdjs.evtsExt__SlotSystem__AddNamedSlot.idToCallbackMap = new Map();
...
let isConditionTrue_0 = false;
{
{runtimeScene.getScene().getVariables().get("__SlotSystem").getChild("_NamedSlots").getChild(eventsFunctionContext.getArgument("SpaceName")).getChild(eventsFunctionContext.getArgument("SlotName")).getChild("Count").setNumber(0);
}
}
