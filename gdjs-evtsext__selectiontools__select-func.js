...
gdjs.evtsExt__SelectionTools__Select.userFunc0x1fafb38 = function GDJSInlineCode(runtimeScene, eventsFunctionContext) {
"use strict";
...
gdjs.evtsExt__SelectionTools__Select.userFunc0x1fafb38(runtimeScene, eventsFunctionContext);
...
};gdjs.evtsExt__SelectionTools__Select.userFunc0x1583db8 = function GDJSInlineCode(runtimeScene, eventsFunctionContext) {
"use strict";
const targets = eventsFunctionContext.getObjectsLists("Targets").items;
const invertSelection = eventsFunctionContext.getArgument("InvertSelection");
...
gdjs.evtsExt__SelectionTools__Select.userFunc0x1583db8(runtimeScene, eventsFunctionContext);
