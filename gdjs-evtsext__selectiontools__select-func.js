...
gdjs.evtsExt__SelectionTools__Select.userFunc0x1104ba0 = function GDJSInlineCode(runtimeScene, eventsFunctionContext) {
"use strict";
...
gdjs.evtsExt__SelectionTools__Select.userFunc0x1104ba0(runtimeScene, eventsFunctionContext);
...
};gdjs.evtsExt__SelectionTools__Select.userFunc0x1603be0 = function GDJSInlineCode(runtimeScene, eventsFunctionContext) {
"use strict";
const targets = eventsFunctionContext.getObjectsLists("Targets").items;
const invertSelection = eventsFunctionContext.getArgument("InvertSelection");
...
gdjs.evtsExt__SelectionTools__Select.userFunc0x1603be0(runtimeScene, eventsFunctionContext);
