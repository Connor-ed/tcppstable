...
if (typeof gdjs.evtsExt__SlotSystem__DeleteGridSlot !== "undefined") {
  gdjs.evtsExt__SlotSystem__DeleteGridSlot.registeredGdjsCallbacks.forEach(callback =>
...
gdjs.evtsExt__SlotSystem__DeleteGridSlot.func = function(runtimeScene, SpaceName, Column, Row, parentEventsFunctionContext) {
...
gdjs.evtsExt__SlotSystem__DeleteGridSlot.eventsList0(runtimeScene, eventsFunctionContext);


return;
}

gdjs.evtsExt__SlotSystem__DeleteGridSlot.registeredGdjsCallbacks = [];