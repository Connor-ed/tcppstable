...
gdjs.evtsExt__SlotSystem__DoesNamedSlotExist.idToCallbackMap = new Map();
...
isConditionTrue_0 = false;
isConditionTrue_0 = gdjs.evtTools.variable.variableChildExists(runtimeScene.getScene().getVariables().get("__SlotSystem").getChild("_NamedSlots").getChild(eventsFunctionContext.getArgument("SpaceName")), eventsFunctionContext.getArgument("SlotName"));
}
if (isConditionTrue_0) {
