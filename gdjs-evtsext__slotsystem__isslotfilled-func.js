...
gdjs.evtsExt__SlotSystem__IsSlotFilled.idToCallbackMap = new Map();
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
isConditionTrue_0 = gdjs.evtTools.variable.variableChildExists(runtimeScene.getScene().getVariables().get("__SlotSystem").getChild(eventsFunctionContext.getArgument("SpaceName")).getChild(eventsFunctionContext.getArgument("Slot")), "Item");
}
}
if (isConditionTrue_0) {
