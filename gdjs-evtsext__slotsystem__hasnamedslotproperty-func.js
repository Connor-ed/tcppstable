...
gdjs.evtsExt__SlotSystem__HasNamedSlotProperty.idToCallbackMap = new Map();
...
isConditionTrue_0 = false;
isConditionTrue_0 = gdjs.evtTools.variable.variableChildExists(runtimeScene.getScene().getVariables().get("__SlotSystem").getChild("_NamedSlots").getChild(eventsFunctionContext.getArgument("SpaceName")).getChild(eventsFunctionContext.getArgument("SlotName")).getChild("Properties"), eventsFunctionContext.getArgument("Property"));
}
if (isConditionTrue_0) {
