...
gdjs.evtsExt__SlotSystem__SetNamedSlotPropertyText.idToCallbackMap = new Map();
...
{gdjs.evtsExt__SlotSystem__SetNamedSlotTextContent.func(runtimeScene, eventsFunctionContext.getArgument("Value"), eventsFunctionContext.getArgument("SpaceName"), eventsFunctionContext.getArgument("SlotName"), eventsFunctionContext.getArgument("Property"), "Properties", eventsFunctionContext);
}
}
