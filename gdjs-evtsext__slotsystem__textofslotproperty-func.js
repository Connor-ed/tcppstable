...
gdjs.evtsExt__SlotSystem__TextOfSlotProperty.idToCallbackMap = new Map();
...
if (isConditionTrue_0) {
{eventsFunctionContext.returnValue = gdjs.evtsExt__SlotSystem__SlotTextContent.func(runtimeScene, eventsFunctionContext.getArgument("SpaceName"), eventsFunctionContext.getArgument("Slot"), eventsFunctionContext.getArgument("Property"), "Properties", eventsFunctionContext);}
}
