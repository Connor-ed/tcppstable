...
gdjs.evtsExt__SlotSystem__SetSlotContent.idToCallbackMap = new Map();
...
{runtimeScene.getScene().getVariables().get("__SlotSystem").getChild(eventsFunctionContext.getArgument("SpaceName")).getChild(eventsFunctionContext.getArgument("Slot")).getChild(eventsFunctionContext.getArgument("Tag")).setNumber(eventsFunctionContext.getArgument("Value"));
}
}
...
if (isConditionTrue_0) {
{runtimeScene.getScene().getVariables().get("__SlotSystem").getChild(eventsFunctionContext.getArgument("SpaceName")).getChild(eventsFunctionContext.getArgument("Slot")).getChild(eventsFunctionContext.getArgument("Parent")).getChild(eventsFunctionContext.getArgument("Tag")).setNumber(eventsFunctionContext.getArgument("Value"));
}
}
