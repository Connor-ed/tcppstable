...
if (typeof gdjs.evtsExt__SlotSystem__FilledSlots !== "undefined") {
  gdjs.evtsExt__SlotSystem__FilledSlots.registeredGdjsCallbacks.forEach(callback =>
    gdjs._unregisterCallback(callback)
  );
}

gdjs.evtsExt__SlotSystem__FilledSlots = {};
gdjs.evtsExt__SlotSystem__FilledSlots.idToCallbackMap = new Map();


gdjs.evtsExt__SlotSystem__FilledSlots.eventsList0 = function(runtimeScene, eventsFunctionContext) {

};gdjs.evtsExt__SlotSystem__FilledSlots.eventsList1 = function(runtimeScene, eventsFunctionContext) {
...
isConditionTrue_0 = gdjs.evtsExt__SlotSystem__IsSlotFilled.func(runtimeScene, eventsFunctionContext.getArgument("SpaceName"), gdjs.evtTools.common.toNumber(gdjs.evtTools.variable.getVariableString(runtimeScene.getScene().getVariables().get("__SlotSystem").getChild("_TmpName"))), eventsFunctionContext);
...
};gdjs.evtsExt__SlotSystem__FilledSlots.eventsList2 = function(runtimeScene, eventsFunctionContext) {
...
{ //Subevents
gdjs.evtsExt__SlotSystem__FilledSlots.eventsList1(runtimeScene, eventsFunctionContext);} //End of subevents
}
...
gdjs.evtsExt__SlotSystem__FilledSlots.func = function(runtimeScene, SpaceName, parentEventsFunctionContext) {
...
gdjs.evtsExt__SlotSystem__FilledSlots.eventsList2(runtimeScene, eventsFunctionContext);


return Number(eventsFunctionContext.returnValue) || 0;
}

gdjs.evtsExt__SlotSystem__FilledSlots.registeredGdjsCallbacks = [];