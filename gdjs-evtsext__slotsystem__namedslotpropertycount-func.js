...
if (typeof gdjs.evtsExt__SlotSystem__NamedSlotPropertyCount !== "undefined") {
  gdjs.evtsExt__SlotSystem__NamedSlotPropertyCount.registeredGdjsCallbacks.forEach(callback =>
    gdjs._unregisterCallback(callback)
  );
}

gdjs.evtsExt__SlotSystem__NamedSlotPropertyCount = {};
gdjs.evtsExt__SlotSystem__NamedSlotPropertyCount.idToCallbackMap = new Map();


gdjs.evtsExt__SlotSystem__NamedSlotPropertyCount.eventsList0 = function(runtimeScene, eventsFunctionContext) {

};gdjs.evtsExt__SlotSystem__NamedSlotPropertyCount.eventsList1 = function(runtimeScene, eventsFunctionContext) {
...
};gdjs.evtsExt__SlotSystem__NamedSlotPropertyCount.eventsList2 = function(runtimeScene, eventsFunctionContext) {
...
{ //Subevents
gdjs.evtsExt__SlotSystem__NamedSlotPropertyCount.eventsList1(runtimeScene, eventsFunctionContext);} //End of subevents
}
...
gdjs.evtsExt__SlotSystem__NamedSlotPropertyCount.func = function(runtimeScene, SpaceName, Property, parentEventsFunctionContext) {
...
gdjs.evtsExt__SlotSystem__NamedSlotPropertyCount.eventsList2(runtimeScene, eventsFunctionContext);


return Number(eventsFunctionContext.returnValue) || 0;
}

gdjs.evtsExt__SlotSystem__NamedSlotPropertyCount.registeredGdjsCallbacks = [];